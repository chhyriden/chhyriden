<div id="manage-left-nav">
    <aside class="menu">
        ...
        <ul class="menu-list">
            <li>
                <a href=" {{route('posts.index')}} " class="{{ Request::is('manage/posts', 'manage/posts/*') ? 'is-active' : '' }}">Posts
                </a>
            </li>

            <li>
                <a href=" {{route('users.index')}} " class="{{ Request::is('manage/users', 'manage/users/*') ? 'is-active' : '' }}">Manage Users
                </a>
            </li>
